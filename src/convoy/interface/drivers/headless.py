...
def _record_spawn(
    ...
    ``cap_usd`` is the ceiling this role's spawn ran under. It is recorded on every line —
    ...
    *when* the ceiling becomes visible, from the exit code to the spawn before it.
